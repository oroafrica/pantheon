((window)=>
{
    ...
    */
    ...
    var _productCharacter = JSON.parse($("#camCharacteristics").text());
    ...
    const subAction = 
    {
        ...
        ,loadFabricSvg:()=>{}  
        ,loadNormalSvg:()=>{} 
        ,test:()=> $(btns[0]).click( ()=> $("#svgString").attr("src","./svg/MS016.svg") )  //log( new XMLSerializer().serializeToString( $("#svgString").attr("src")));
        ,debugLog:()=> 
        {   
            let report = {};
    ...
    let functions = (camStyle = "NONE")=>
    {
        ...
        // let s =  JSON.parse($("#camCharacteristics").text()).charac_camCode;
        //log(s); 
        // let k = s+"888";
        // log(k);
        // log(camGroup[k]);
        _productCharacter = JSON.parse($("#camCharacteristics").text()).charac_camCode;
        log(typeof _productCharacter);
        var s = "PATHS";
        let action = camGroup[s];
